  ...
  faqs: FAQ[] = [
    {
      ...
      answers: ['Você pode entrar em contato através do nosso WhatsApp, lá nós poderemos resolver seu problema com maior facilidade e agilidade.'],
      showAnswer: false
    },
    {
    ...
    },
    {
      ...
      answers: ['Nosso horário de atendimento é de segunda a sexta, das 9h às 18h.'],
      showAnswer: false
    }
  ];
